...
app.get('/', function (req, res) {
    //res.render('search')
    let fetchData = async () => {
        const res = await axios.get(`https://api.themoviedb.org/3/trending/tv/week?api_key=f2e1db77c8ae74a5c21ae7b7d5630dfb`);

        const tvData = res['data'];
        const res2 = await axios.get(`https://api.themoviedb.org/3/trending/movie/week?api_key=f2e1db77c8ae74a5c21ae7b7d5630dfb`);
